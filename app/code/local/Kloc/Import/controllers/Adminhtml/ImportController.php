...
class Kloc_Import_Adminhtml_ImportController extends Mage_Adminhtml_Controller_action
{
	...
	public function relatedproductPostAction(){
		
		if(isset($_FILES['file']['name']) && $_FILES['file']['name'] != '') {  
			try{
				$relatedproduct = Mage::getModel('import/relatedproduct');
				$relatedproduct->import(); 
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('import')->__('%s Product updated.', $relatedproduct->getProductCount()));
			}catch(Exception $e){
	...
	public function downloadImageFormatAction(){  
		...
		$fileName = 'Products_images_format.csv';  
        $content    =  file_get_contents(Mage::getBaseDir().DS.'product'.DS.'csv'.DS.'format'.DS.'Products_images_format.csv'); 
        $this->_sendUploadResponse($fileName, $content);
	}
	public function downloadRelatedProductFormatAction(){  
		
		$fileName = 'RelatedProducts_format.csv';  
        $content    =  file_get_contents(Mage::getBaseDir().DS.'product'.DS.'csv'.DS.'format'.DS.'RelatedProducts_format.csv'); 
        $this->_sendUploadResponse($fileName, $content);
	} 
    ...
    public function exportProductCsvAction(){
        ...
        $block  = $this->getLayout()->createBlock('import/adminhtml_export_product');
        Mage::register('export_product_block', $block);
